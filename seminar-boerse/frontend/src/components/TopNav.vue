...
const isAdmin = keycloak.hasRealmRole("seminar-admin");
</script>
      ...
      >
        <ul class="py-2">
          <li
            ...
            "
          >
            <h2 class="w-full h-full flex justify-start items-center">Home</h2>
          </li>
          <li
            class="px-4 py-2 hover:bg-gray-100 cursor-pointer"
            @click="
            ...
            "
          >
            <h2 class="w-full h-full flex justify-start items-center">
              Seminarübersicht
            </h2>
          </li>
          <li
